...
var URL_DEFAULT = "http://shrouded-mesa-6336.herokuapp.com/";
...
var assertURLExists = function(inurl) {
	...
	rest.get(instr).on('complete', function(result) {
	  if (result instanceof Error) {
        console.log("%s cannot be accessed. Exiting.", instr);
        process.exit(1); // http://nodejs.org/api/process.html#process_process_exit_code
  		} 

   	  fs.writeFileSync(HTMLFILE_DEFAULT, result);
	  return HTMLFILE_DEFAULT; //is this needed at all?
	});																											
};
